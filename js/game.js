...
ship0,ship1,ship2,ship3,ship4, logs, s0, s1,s2, userHit, opponent,
shipIA0,shipIA1,shipIA2, numberShipIa, allowHit, playToRound,
round, score;
let victory = "Easy";
score = 0;
numberDiv = 200;
...
shipU2 = ship2.innerText.split(splitV);
